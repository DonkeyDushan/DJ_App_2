 ...
 * Generates AudioBuffer content for demo tracks and impulse responses.
 */

export const createImpulseResponse = (context: AudioContext): AudioBuffer => {
